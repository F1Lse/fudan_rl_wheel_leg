...
STAGE_KEYS=(
  ...
  reflex_speed_rebalanced_2p0
  reflex_speed_rebalanced_final_2p0
)
STAGE_LABELS=(
  "低速适应：认识俯仰约束"
  "中速强化：压低台阶冲击俯仰"
  ...
  "高速快速收腿驱轮巩固：2.0 m/s"
  "高速碰坎俯仰抑制：2.0 m/s"
  "修正版：高速跟踪与单次冲击收腿：2.0 m/s"
  "修正版：高速、收伸腿与俯仰联合巩固：2.0 m/s"
)
STAGE_TARGETS=(58000 60000 62500 63500 65000 66000 67000 68000 69000 70000 71000 72000 73500 74500 75500 76500)
STAGE_RUN_NAMES=(
  ...
  descent_speed_rebalanced_longlegs_s15_speed_2p0
  descent_speed_rebalanced_longlegs_s16_speed_2p0
)
...
apply_common_environment() {
  ...
  export WLG_TERRAIN_IMPACT_REARM_CLEAR_S=0.08
...
apply_stage_environment() {
  ...
  case "${STAGE_KEYS[$stage_index]}" in
    ...
    reflex_speed_rebalanced_2p0)
      ...
      export WLG_MIXED_TERRAIN_LIN_VEL_MAX=1.2
      export WLG_MIXED_CUSTOM_LIN_VEL_MAX=2.0
      export WLG_MIXED_CUSTOM_HIGH_SPEED_FRACTION=0.50
      export WLG_MIXED_CUSTOM_HIGH_SPEED_MIN=1.50
      export WLG_STAIR_UP_FIXED_HEIGHT=0.33
      export WLG_TRACKING_LIN_VEL_SCALE=2.4
      export WLG_TRACKING_LIN_VEL_ENHANCE_SCALE=2.5
      export WLG_TRACKING_LIN_VEL_L1_SCALE=-0.60
      export WLG_CLIP_SINGLE_REWARD=4.0
      export WLG_BASE_HEIGHT_SCALE=3.0
      export WLG_BASE_HEIGHT_ENHANCE_SCALE=2.0
      export WLG_BASE_HEIGHT_L1_SCALE=-0.8
      ...
      export WLG_WHEEL_SUPPORT_SCALE=2.0
      export WLG_TERRAIN_PITCH_SOFT_LIMIT_DEG=9
      export WLG_TERRAIN_PITCH_TERMINATION_DEG=30
      export WLG_FAIL_TO_TERMINAL_TIME_S=0.14
      export WLG_TERRAIN_PITCH_EXCESS_SCALE=-62.0
      export WLG_TERRAIN_PITCH_RATE_SCALE=-0.78
      ...
      export WLG_TERRAIN_IMPACT_TUCK_VELOCITY_SCALE=0.55
      export WLG_TERRAIN_IMPACT_TUCK_SPEED_GAIN=0.85
      export WLG_TERRAIN_IMPACT_DRIVE_SCALE=4.6
      export WLG_TERRAIN_IMPACT_TUCK_HOLD_S=0.11
      export WLG_TERRAIN_IMPACT_EXTEND_SCALE=2.9
      export WLG_TERRAIN_IMPACT_EXTEND_VELOCITY_SCALE=0.18
      export WLG_TERRAIN_IMPACT_EXTEND_ORIENTATION_SCALE=-18.0
    ...
    reflex_speed_rebalanced_final_2p0)
      ...
      export WLG_MIXED_TERRAIN_LIN_VEL_MAX=1.2
      export WLG_MIXED_CUSTOM_LIN_VEL_MAX=2.0
      export WLG_MIXED_CUSTOM_HIGH_SPEED_FRACTION=0.60
      export WLG_MIXED_CUSTOM_HIGH_SPEED_MIN=1.55
      export WLG_STAIR_UP_FIXED_HEIGHT=0.33
      ...
      export WLG_BASE_HEIGHT_L1_SCALE=-0.8
      export WLG_ORIENTATION_SCALE=-13.0
      export WLG_WHEEL_SUPPORT_SCALE=2.2
      export WLG_TERRAIN_PITCH_SOFT_LIMIT_DEG=9
      export WLG_TERRAIN_PITCH_TERMINATION_DEG=29
      export WLG_FAIL_TO_TERMINAL_TIME_S=0.14
      export WLG_TERRAIN_PITCH_EXCESS_SCALE=-64.0
      export WLG_TERRAIN_PITCH_RATE_SCALE=-0.80
      export WLG_TERRAIN_IMPACT_HORIZONTAL_FORCE=8.0
      export WLG_TERRAIN_IMPACT_FORCE_RATIO=0.20
      export WLG_TERRAIN_IMPACT_SPEED_RATIO=1.25
      export WLG_TERRAIN_IMPACT_TUCK_SCALE=4.2
      export WLG_TERRAIN_IMPACT_TUCK_VELOCITY_SCALE=0.58
      export WLG_TERRAIN_IMPACT_TUCK_SPEED_GAIN=0.90
      export WLG_TERRAIN_IMPACT_DRIVE_SCALE=4.8
      export WLG_TERRAIN_IMPACT_TUCK_HOLD_S=0.11
      export WLG_TERRAIN_IMPACT_EXTEND_SCALE=3.0
      export WLG_TERRAIN_IMPACT_EXTEND_VELOCITY_SCALE=0.20
      export WLG_TERRAIN_IMPACT_EXTEND_ORIENTATION_SCALE=-19.0
      export WLG_TERRAIN_IMPACT_PITCH_SCALE=-23.0
      export WLG_TERRAIN_IMPACT_PITCH_RATE_SCALE=-0.95
      export WLG_ENTROPY_COEF=0.0008
      ;;
...
print_stage_config() {
  ...
  printf '  impact_trigger=%sN / ratio %s, rearm_after_clear=%ss\n' \
    "$WLG_TERRAIN_IMPACT_HORIZONTAL_FORCE" \
    "$WLG_TERRAIN_IMPACT_FORCE_RATIO" \
    "$WLG_TERRAIN_IMPACT_REARM_CLEAR_S"
